...
export const AppointmentCard = () => {
  ...
  return (
    ...
    <div className="w-[321px] h-[313px] border-2 rounded-3xl shadow-blue-400 shadow-sm m-6">
      
      <div className="user-details flex py-2 px-3 w-full justify-between mt-3">
      ...
      <div className="cont px-4 py-1">
        <div className="flex justify-between p-1">
          <p className="text-[#505050] font-medium">Date</p>
          <p className="text-[#505050] font-normal">22 Sep 2024</p>
        </div>
        <div className="flex justify-between p-1">
          <p className="text-[#505050] font-medium">Time</p>
          <p className="text-[#505050] font-normal">4:05 pm</p>
        </div>
        <div className="flex justify-between p-1">
          <p className="text-[#505050] font-medium">Duration</p>
          <p className="text-[#505050] font-normal">45 min</p>
        </div>
        <div className="flex justify-between p-1">
          <p className="text-[#505050] font-medium">Contact</p>
          <p className="text-[#505050] font-normal"> +91 790772727</p>
        </div>
      </div>
      <div className="px-6">
      <Slidercomp />
