...
import { Tabs, ScrollArea, Radio, Modal, Group, Button, Loader, Text } from "@mantine/core";
...
const Settings = () => {
  ...
  useEffect(() => {
    const fetchProfessionalDetails = async () => {
      setLoading(true);
      try {
        const response = await fetch(`${API_BASE_URL}/professionals/2`);
        if (!response.ok) {
        ...
        <ScrollArea viewportRef={scrollAreaRef} style={{ flexGrow: 1 }}>
          <Tabs defaultValue="account">
            <Tabs.List grow justify="center">
              ...
              <Tabs.Tab value="deleteaccount">Deactivate/Delete Account</Tabs.Tab>
            ...
            <div className="p-4">
              <Tabs.Panel value="account">
                ...
                {loading ? (
                  ...
                  <PersonalInformation data={professionalData} />
                )}
              </Tabs.Panel>
